...
public class Mine : MonoBehaviour
{
    ...
    private void Start()
    {
        InvokeRepeating("GatheringResources", 0.0f, (float)(5 - (workersActive * 1))); //subtracts 1 seconds off for each new worker
    }
    ...
    private void GatheringResources()
    {
        ...
        for(int i = 0; i < Mathf.FloorToInt((1 * workersActive) * Mathf.Pow(statMultiplier, 1f / 3f)); i++)
        {
