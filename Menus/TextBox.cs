...
public class TextBox : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        else if (ResidentTalkingTo.transform.parent.name == "Resident" && ResidentTalkingTo.transform.GetComponent<ResidentStats>().joinedTown && buildMenuUpdater.AccessToLevel1Buildings)
        {
            textBox.text = "What can I do for you boss?";
            TurnMovementOff();
        }
        else if (ResidentTalkingTo.transform.parent.name == "Resident" && !buildMenuUpdater.AccessToLevel1Buildings)
        {
